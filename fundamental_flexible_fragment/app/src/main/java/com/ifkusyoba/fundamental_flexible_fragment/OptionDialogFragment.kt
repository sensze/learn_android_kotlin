package com.ifkusyoba.fundamental_flexible_fragment
...
class OptionDialoFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_option_dialo, container, false)
    }
